...
class UserServiceTest {
    ...
    void testCreateUserNullUser() {
        ...
        assertNull(result, "Should return null for null user");
    }
    ...
    void testCreateUserNullUserId() {
        ...
        User result = userService.create(userWithNullId);
    ...
    void testReadUserNullUserId() {
        Optional<User> result = userService.read(null);
        assertTrue(result.isEmpty(), "Should return empty Optional for null userId");
    }
    ...
    void testDeleteUserNullUserId() {
        ...
        assertFalse(deleted, "Should return false for null userId");
    }
    ...
    void testSearchByUserNameNullUserName() {
        List<User> results = userService.searchByUserName(null);
        assertNull(results, "Should return null for null userName");
    }
    ...
    void testSearchByEmailNullEmail() {
        Optional<User> result = userService.searchByEmail(null);
        assertTrue(result.isEmpty(), "Should return empty Optional for null email");
    }
    ...
    void testSearchByPatternNullPattern() {
        List<User> results = userService.searchUsersByPattern(null);
        assertNull(results, "Should return null for null pattern");
    }
